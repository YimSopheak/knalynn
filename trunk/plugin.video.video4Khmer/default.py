...
def HOME():
        addDir('Thai Series','http://www.vdokhmer.com/browse-khmer-movie-thai-lakorn-drama-videos-1-date.html?ModPagespeed=noscript',2,'http://www.khmernz.com/xbmc/khmer2all/thaiseries.jpg')
        addDir('Thai Single','http://www.vdokhmer.com/browse-khmer-thai-movie-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/thai.png')
        addDir('Chinese Series','http://www.vdokhmer.com/browse-khmer-movie-chinese-drama-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/chineseseries.jpg')
        addDir('Chinese Single','http://www.vdokhmer.com/browse-khmer-chinese-movie-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/chinesesingle.jpg')
        addDir('Khmer Series','http://www.vdokhmer.com/browse-khmer-drama-watch-online-free-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/khmerseries.jpg')
        addDir('Khmer Single','http://www.vdokhmer.com/browse-khmer-movies-watch-online-free-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/khmer.png')
        addDir('Khmer Comedy','http://www.vdokhmer.com/browse-khmer-comedy-watch-online-free-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/comedy.png')
        addDir('Khmer Boxing','http://www.vdokhmer.com/browse-khmer-boxing-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/kboxing.png')
        addDir('Hang Meas Karaoke','http://www.vdokhmer.com/browse-hang-meas-khmer-video-karaoke-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/rhm.png')
        addDir('Sunday Khmer Karaoke','http://www.vdokhmer.com/browse-sunday-khmer-video-karaoke-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('Town Production Karaoke','http://www.vdokhmer.com/browse-town-production-khmer-video-karaoke-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('Big Man Khmer Karaoke','http://www.vdokhmer.com/browse-big-man-khmer-video-karaoke-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('M Production Karaoke','http://www.vdokhmer.com/browse-m-production-khmer-video-karaoke-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('Rock Production Karaoke','http://www.vdokhmer.com/browse-rock-production-khmer-video-karaoke-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('Spark Production Karaoke','http://www.vdokhmer.com/browse-spark-production-khmer-video-karaoke-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('Chenla Brother Karaoke','http://www.vdokhmer.com/browse-chenla-brother-khmer-video-karaoke-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('Khmer video clip','http://www.vdokhmer.com/browse-khmer-clips-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('Khmer Tv show','http://www.vdokhmer.com/browse-watch-cambodia-tv-shows-online-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('Funney Videos','http://www.vdokhmer.com/browse-funny-video-clips-videos-1-date.html',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')		
def INDEX(url):
    #try:
        link = GetContent(url)
        try:

...
ADDON = __settings__ = xbmcaddon.Addon(id='plugin.video.KhmerMedia')
home = __settings__.getAddonInfo('path')
filename = xbmc.translatePath(os.path.join(home, 'resources', 'KhmerMedia.xml'))

if ADDON.getSetting('ga_visitor')=='':
    from random import randint
    ADDON.setSetting('ga_visitor',str(randint(0, 0x7fffffff)))
    
PATH = "KhmerMedia"  #<---- PLUGIN NAME MINUS THE "plugin.video"          

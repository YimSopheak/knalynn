...
def HOME():
        addDir('Thai Lakorns','http://moviekhmer.com/category/thai/thai-lakorns/',2,'http://www.khmernz.com/xbmc/khmer2all/thai.png')
        addDir('Thai Movies','http://moviekhmer.com/category/thai/thai-movies/',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('Chinese Series','http://moviekhmer.com/category/chinese/chinese-series/',2,'http://www.khmernz.com/xbmc/khmer2all/chinese.png')
        addDir('Chinese Movies','http://moviekhmer.com/category/chinese/chinese-movies/',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')		
        addDir('Korean Drama','http://moviekhmer.com/category/korean/korean-dramas/',2,'http://www.khmernz.com/xbmc/khmer2all/korean.png')
        addDir('Korean Movies','http://moviekhmer.com/category/korean/korean-movies/',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')		
        addDir('Khmer Comedy','http://moviekhmer.com/category/khmer/khmer-comedy/',2,'http://www.khmernz.com/xbmc/khmer2all/comedy.png')
        addDir('Khmer Movies','http://moviekhmer.com/category/khmer/khmer-movies/',2,'http://www.khmernz.com/xbmc/khmer2all/khmer.png')
        addDir('Khmer Song','http://moviekhmer.com/category/khmer/khmer-songs/',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('Khmer TV Show','http://moviekhmer.com/category/khmer/khmer-tv-show-khmer/',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')
        addDir('Documentaries','http://moviekhmer.com/category/uncategories/documentary-uncategories/',2,'http://www.khmernz.com/xbmc/khmer2all/nologo.png')

...
def HOME():
	...
	addDir('THAI SERIES',strdomain+'category/thai/thai-lakorns/',2,'http://www.khmernz.com/xbmc/khmer2all/thaiseries.jpg')
	addDir('THAI SINGLE',strdomain+'category/thai/thai-movies/',2,'http://www.khmernz.com/xbmc/khmer2all/thai.png')
	addDir('CHINESE',strdomain+'category/chinese/',2,'http://www.khmernz.com/xbmc/khmer2all/chinese.png')
	addDir('KHMER TVSHOW',strdomain+'category/khmer/khmer-tv-show-khmer/',2,'http://www.khmernz.com/xbmc/khmer2all/khmertvshow.jpg')	

...
def HOME():
#	addDir('KHMER-COMEDY',strdomain+'category/khmer/khmer-comedy/',2,'http://www.khmernz.com/xbmc/khmer2all/comedya.png')
	addDir('THAI SERIES',strdomain+'category/thai/thai-lakorn/',2,'http://www.khmernz.com/xbmc/khmer2all/thaiseries.jpg')
	addDir('THAI SINGLE',strdomain+'category/thai/',2,'http://www.khmernz.com/xbmc/khmer2all/thai.png')
	addDir('CHINESE',strdomain+'category/chinese/chinese-drama/',2,'http://www.khmernz.com/xbmc/khmer2all/chinese.png')
	addDir('KHMER TVSHOW',strdomain+'category/khmer/',2,'http://www.khmernz.com/xbmc/khmer2all/khmertvshow.jpg')	
#	addDir('KHMER-MOVIE',strdomain+'category/khmer/khmer-movies/',2,'http://www.khmernz.com/xbmc/khmer2all/khmer.png')
#	addDir('KHMER-SONGS',strdomain+'category/khmer/khmer-songs/',2,'http://www.khmernz.com/xbmc/khmer2all/khmersong.jpg')
#	addDir('KOREAN','http://moviekhmer.com/category/korean/',2,'http://www.khmernz.com/xbmc/khmer2all/korean.png')	
	addDir('Documentaries',strdomain+'category/uncategorized/',2,'http://www.khmernz.com/xbmc/khmer2all/documentary.jpg')
...
def INDEX(url):
    #try:
        ...
        match5=re.compile('<a class="nextpostslink" href="(.+?)">([^>]+)</a>').findall(newlink)
        if(len(match5)):

...
VERSION = "0.0.7" #<---- PLUGIN VERSION

strdomain ='http://moviekhmer.com/'
def HOME():
	addDir('KHMER-COMEDY','http://moviekhmer.com/category/khmer/khmer-comedy/',2,'http://www.khmernz.com/xbmc/khmer2all/comedya.png')
	addDir('THAI SERIES','http://moviekhmer.com/category/thai/thai-lakorns/',2,'http://www.khmernz.com/xbmc/khmer2all/thaiseries.jpg')
	addDir('THAI SINGLE','http://moviekhmer.com/category/thai/thai-movies/',2,'http://www.khmernz.com/xbmc/khmer2all/thai.png')
	addDir('CHINESE','http://moviekhmer.com/category/chinese/',2,'http://www.khmernz.com/xbmc/khmer2all/chinese.png')
	addDir('KHMER TVSHOW','http://moviekhmer.com/category/khmer/khmer-tv-show-khmer/',2,'http://www.khmernz.com/xbmc/khmer2all/khmertvshow.jpg')	
	addDir('KHMER-MOVIE','http://moviekhmer.com/category/khmer/khmer-movies/',2,'http://www.khmernz.com/xbmc/khmer2all/khmer.png')
	addDir('KHMER-SONGS','http://moviekhmer.com/category/khmer/khmer-songs/',2,'http://www.khmernz.com/xbmc/khmer2all/khmersong.jpg')
	addDir('KOREAN','http://moviekhmer.com/category/korean/',2,'http://www.khmernz.com/xbmc/khmer2all/korean.png')	
	addDir('Documentaries','http://moviekhmer.com/category/uncategories/documentary-uncategories/',2,'http://www.khmernz.com/xbmc/khmer2all/documentary.jpg')

...
strdomain ='http://www.phumikhmer.com/'
def HOME():
        addDir('Thai Lakorns','http://www.phumikhmer.com/search/label/Thai%20Drama?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/thaiseries.jpg')
        addDir('Thai Movies','http://www.phumikhmer.com/search/label/Thai%20Movies?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/thai.png')		
        addDir('Khmer Drama','http://www.phumikhmer.com/search/label/Khmer%20Drama?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/khmerseries.jpg')
        addDir('Khmer Movies','http://www.phumikhmer.com/search/label/Khmer%20Movies?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/khmer.png')		
        addDir('Filipino Drama','http://www.phumikhmer.com/search/label/Philippine%20Movie?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/philippine.png')
        addDir('Korean Drama','http://www.phumikhmer.com/search/label/Korean%20Drama?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/koreandrama.jpg')
        addDir('Korean Movies','http://www.phumikhmer.com/search/label/Korean%20Movies?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/korean.png')
        addDir('Hong Kong Drama','http://www.phumikhmer.com/search/label/Hong%20Kong%20Drama?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/hongkongseries.jpg')
        addDir('Hong Kong Movies','http://www.phumikhmer.com/search/label/Hong%20Kong%20Movies?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/hongkongsingle.jpg')
        addDir('Taiwanese Drama','http://www.phumikhmer.com/search/label/Taiwan%20Series?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/taiwanseries.jpg')
        addDir('Chinese Series','http://www.phumikhmer.com/search/label/Chinese%20Series?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/chineseseries.jpg')
        addDir('Chinese Movie','http://www.phumikhmer.com/search/label/Chinese%20Movies?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/chinesesingle.jpg')		
        addDir('Documentaries','http://www.phumikhmer.com/search/label/Documentary?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/documentary.jpg')
...
def buildNextPage(pagenum,label):
	...
	url="http://www.phumikhmer.com/feeds/posts/summary/-/"+label+"?start-index="+pagecount+"&max-results=1&alt=json-in-script&callback=finddatepost"
	link = GetContent(url)
	try:
		link =link.encode("UTF-8")
	except: pass
	...
	if(len(match)>0):
		...
		newurl="http://www.phumikhmer.com/search/label/"+label+"?updated-max="+tsvalue+"&max-results=18#PageNo="+pagenum
	else:
		newurl=""
	return newurl

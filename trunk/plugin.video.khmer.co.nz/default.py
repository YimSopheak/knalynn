...
common.plugin = "plugin.video.khmer.co.nz"

import time
ADDON = xbmcaddon.Addon(id='plugin.video.khmer.co.nz')
...
def HOME():
        addDir('Thai Lakorns','http://www.phumikhmers.blogspot.com/search/label/Thai%20Lakorn?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/thaiseries.jpg')
        addDir('Thai Movies','http://www.phumikhmers.blogspot.com/search/label/Thai%20Movies?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/thai.png')		
        addDir('Khmer Drama','http://www.phumikhmers.blogspot.com/search/label/Khmer%20Drama?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/khmerseries.jpg')
        addDir('Khmer Movies','http://www.phumikhmers.blogspot.com/search/label/Khmer%20Movies?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/khmer.png')		
        addDir('Filipino Drama','http://www.phumikhmers.blogspot.com/search/label/Philippine%20Movie?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/philippine.png')
        addDir('Korean Drama','http://www.phumikhmers.blogspot.com/search/label/Korean%20Drama?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/koreandrama.jpg')
        addDir('Korean Movies','http://www.phumikhmers.blogspot.com/search/label/Korean%20Movies?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/korean.png')
        addDir('Hong Kong Drama','http://www.phumikhmers.blogspot.com/search/label/Hong%20Kong%20Drama?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/hongkongseries.jpg')
        addDir('Hong Kong Movies','http://www.phumikhmers.blogspot.com/search/label/Hong%20Kong%20Movies?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/hongkongsingle.jpg')
        addDir('Taiwanese Drama','http://www.phumikhmers.blogspot.com/search/label/Taiwan%20Series?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/taiwanseries.jpg')
        addDir('Chinese Series','http://www.phumikhmers.blogspot.com/search/label/Chinese%20Series?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/chineseseries.jpg')
        addDir('Chinese Movie','http://www.phumikhmers.blogspot.com/search/label/Chinese%20Movies?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/chinesesingle.jpg')		
        addDir('Documentaries','http://www.phumikhmers.blogspot.com/search/label/Documentary?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/documentary.jpg')
        addDir('Other Shows','http://www.phumikhmers.blogspot.com/search/label/Hong%20Kong%20Drama?&max-results=18',6,'http://www.khmernz.com/xbmc/khmer2all/khmertvshow.jpg')		
#       addDir('Paik Mee','http://www.phumikhmer.com/search/label/Parkmi%20%28%E1%9E%96%E1%9E%B6%E1%9E%80%E1%9F%8B%E1%9E%98%E1%9E%B8%29?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/comedy.png')
#       addDir('TV program','http://www.phumikhmer.com/search/label/TV%20Programe?&max-results=18',2,'http://www.khmernz.com/xbmc/khmer2all/khmertvshow.jpg')	
...
def Episodes(url,name):
    #try:
        ...
        if(len(match1) > 0):
				match1=re.compile('data-vid="(.+?)"><img /><span class="v-title">(.+?)</span>').findall(match1[0])
				for mcontent in match1:
					vLink,vLinkName=mcontent
					addLink(vLinkName.encode("utf-8"),"http://player.vimeo.com/video/"+vLink,3,"")

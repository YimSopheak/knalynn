...
def INDEX(url):
        ...
        if(len(match) >= 1):
                linkmatch=re.compile('<div class="archivehoriz_label"><a href="(.+?)" ><span class="thumb_image" style="display:block"><img src="(.+?)" width="100" height="75" title=".+?" alt="(.+?)" />').findall(match[0])

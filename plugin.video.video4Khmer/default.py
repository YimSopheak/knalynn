...
UATRACK="UA-37729692-1" #<---- GOOGLE ANALYTICS UA NUMBER   
VERSION = "1.0.23" #<---- PLUGIN VERSION
def HOME():
        addDir('Thai Series','http://www.vdokhmer.com/khmer-movie-category/thai-lakorn-drama-watch-online-free-catalogue-537-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/thaiseries.jpg')
        addDir('Thai Single','http://www.vdokhmer.com/khmer-movie-category/thai-movie-watch-online-free-catalogue-525-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/thai.png')
        addDir('Chinese Series','http://www.vdokhmer.com/khmer-movie-category/chinese-series-drama-watch-online-free-catalogue-506-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/chineseseries.jpg')
        addDir('Chinese Single','http://www.vdokhmer.com/khmer-movie-category/chinese-movie-watch-online-free-catalogue-505-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/chinesesingle.jpg')
        addDir('Khmer Series','http://www.vdokhmer.com/khmer-movie-category/khmer-drama-watch-online-free-catalogue-504-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/khmerseries.jpg')
        addDir('Khmer Single','http://www.vdokhmer.com/khmer-movie-category/khmer-movies-watch-online-free-catalogue-503-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/khmer.png')
        addDir('Khmer Comedy','http://www.vdokhmer.com/khmer-movie-category/khmer-comedy-watch-online-free-catalogue-502-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/comedy.png')
        addDir('Khmer Boxing','http://www.vdokhmer.com/khmer-movie-category/khmer-boxing-watch-online-free-catalogue-1361-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/kboxing.png')
        addDir('Pleng karaoke','http://www.vdokhmer.com/khmer-movie-category/phleng-production-khmer-video-karaoke-catalogue-2845-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/pleng.jpg')
        addDir('Hangmeas karaoke','http://www.vdokhmer.com/khmer-movie-category/hang-meas-khmer-video-karaoke-catalogue-509-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/rhm.png')
        addDir('Sunday Karaoke','http://www.vdokhmer.com/khmer-movie-category/sunday-khmer-video-karaoke-catalogue-510-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/sunday.jpg')
        addDir('Town Karaoke','http://www.vdokhmer.com/khmer-movie-category/town-production-khmer-video-karaoke-catalogue-514-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/town.jpg')
        addDir('BigMan Karaoke','http://www.vdokhmer.com/khmer-movie-category/big-man-khmer-video-karaoke-catalogue-512-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/bigman.jpg')
        addDir('M Karaoke','http://www.vdokhmer.com/khmer-movie-category/m-production-khmer-video-karaoke-catalogue-511-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/m.jpg')
        addDir('Rock Karaoke','http://www.vdokhmer.com/khmer-movie-category/rock-production-khmer-video-karaoke-catalogue-513-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/rock.jpg')
        addDir('Spark Karaoke','http://www.vdokhmer.com/khmer-movie-category/spark-production-khmer-video-karaoke-catalogue-516-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/spark.jpg')
        addDir('ChenlaBrother Karaoke','http://www.vdokhmer.com/khmer-movie-category/chenla-brother-khmer-video-karaoke-catalogue-518-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/chenla.jpg')
        addDir('Khmer clip','http://www.vdokhmer.com/khmer-movie-category/khmer-clips-watch-online-free-catalogue-1366-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/khmervclub.jpg')
        addDir('KhmerTv show','http://www.vdokhmer.com/khmer-movie-category/watch-cambodia-tv-shows-online-catalogue-1278-page-1.html',2,'http://www.khmernz.com/xbmc/khmer2all/khmertvshow.jpg')
...
def Episodes(url,name):
    #try:
        ...
        if(len(match) >= 1):
                ...
                for vpic in linkmatch:
                    vimg=""
                    vidlink=re.compile('<a [^>]*href=["\']?([^>^"^\']+)["\']?[^>]* title="(.+?)">').findall(vpic)
                    (vurl,vname)=vidlink[0]
                    counter += 1
